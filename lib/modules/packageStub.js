...
const stubThemeSources = function ({ PATHS }) {
  ...
  const packageJson = require(PATHS.themePackageJson);
  ...
  packageJson.name += '-stub';
  packageJson.description += ' stub';

  zipThemeSources.addFile('package.json', JSON.stringify(packageJson, null, 2));
